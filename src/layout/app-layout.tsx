...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['app-owner', 'content-creator', 'motivational-speaker'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Quotes', path: '/quotes', entity: 'quote', service: AccessServiceEnum.PROJECT, icon: FiMessageCircle },
