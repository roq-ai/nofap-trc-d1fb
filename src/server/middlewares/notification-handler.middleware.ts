...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Content Creator.create': {
    roles: ['app-owner', 'content-creator'],
    key: 'content_published',
    tenantPath: [],
    userPath: [],
  },
  'Motivational Speaker.create': {
    roles: ['app-owner', 'motivational-speaker'],
    key: 'speech_scheduled',
    tenantPath: [],
    userPath: [],
  },
  'Customer.create': {
    roles: ['app-owner', 'content-creator', 'motivational-speaker'],
...
const ownerRoles: string[] = ['app-owner'];
const customerRoles: string[] = ['customer'];
const tenantRoles: string[] = ['app-owner', 'content-creator', 'motivational-speaker'];
