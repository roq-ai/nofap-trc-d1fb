...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`NOFAP TRC`}</title>

        <meta
          name="description"
          content="With NOFAP TRC, empower yourself to quit addictive habits, embrace a millionaire mindset, track your progress with day streaks, plan your days, and find inspiration in motivational quotes"
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1528716321680-815a8cdb8cbe?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxtb3RpdmF0aW9ufGVufDB8fHx8MTY5NTQ2Nzk4Mnww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`With NOFAP TRC, empower yourself to quit addictive habits, embrace a millionaire mindset, track your progress with day streaks, plan your days, and find inspiration in motivational quotes`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="App Owner" type="app-owner" abilities={appConfig.ownerAbilities} />
